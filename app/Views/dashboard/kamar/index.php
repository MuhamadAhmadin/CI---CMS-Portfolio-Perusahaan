        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col s2 m2 l2">
                    <div class="right">
                        <a href="<?= base_url('dashboard/kamar/new') ?>"
                        ...
                        <table id="data-table-simple" class="responsive-table display" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?= $item->no_kamar ?></td>
                                    <td><?= $item->lantai ?></td>
                                    <td><?= $item->max_orang ?> Orang</td>
                                    <td><?= $item->kelas ?></td>
                                    <td>
                                        <a href="<?= base_url('dashboard/kamar/'.$item->id.'/edit') ?>" class="btn btn-sm waves-effect waves-light yellow">Edit</a>
                                        <a href="#"
                                                    data-href="<?= base_url('dashboard/kamar/'.$item->id.'/delete') ?>"
