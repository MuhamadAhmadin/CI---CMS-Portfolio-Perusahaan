            ...
            <div id="table-datatables">
                <div class="row">
                    ...
                    <div class="col s12 m12 l12">
                        <form class="col s12" action="<?= base_url('dashboard/kamar/store') ?>" method="post">
                            <?= $this->include('components/validation_checker'); ?>
                            <div class="row">
                                <div class="input-field col s6 m3">
                                    <input id="no_kamar" name="no_kamar" type="text" class="validate">
                                    <label for="no_kamar">Nomor Kamar</label>
                                </div>
                                <div class="input-field col s6 m3">
                                    <input id="lantai" name="lantai" type="text" class="validate">
                                    <label for="lantai">Lantai</label>
                                </div>
                                <div class="input-field col s6 m3">
                                    <input id="max_orang" name="max_orang" type="text" class="validate">
