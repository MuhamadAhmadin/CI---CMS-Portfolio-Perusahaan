            ...
            <div id="table-datatables">
                <div class="row">
                    ...
                    <div class="col s12 m12 l12">
                        <form class="col s12" action="<?= base_url('dashboard/pasien/store') ?>" method="post">
                            <?= $this->include('components/validation_checker'); ?>
                            <div class="row">
                                <div class="input-field col s6 m4">
                                    <input id="no_pasien" name="no_pasien" type="text" class="validate">
                                ...
                                <div class="input-field col s6 m4">
                                    <input id="telepon" name="telepon" type="number" class="validate">
                                    <label for="telepon">Nomor Telepon</label>
                                </div>
                                <div class="input-date col s4 m4">
                                    <label for="tanggal_datang">Tanggal Datang/Berobat</label>
                                    <input id="tanggal_datang" name="tanggal_datang" type="date" value="<?= date('Y-m-d') ?>" class="validate">
                                </div>
                                ...
                                <div class="input-field col s12 m12">
                                    <label>Keluhan</label>
                                    <textarea id="keluhan" name="keluhan" class="materialize-textarea"></textarea>
                                </div>
                                <div class="input-field col s6 m6">
                                    <label>Harga Jasa (Masukkan angka saja)</label>
                                    <input id="harga_jasa" name="harga_jasa" type="number" min="0" value="0" class="validate">
                                </div>
                            </div>
