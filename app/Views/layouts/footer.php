                ...
                <li>
                    ...
                    <div class="collapsible-body favorite-associates">
                        <div class="favorite-associate-list chat-out-list row">
                            <div class="col s4"><img src="<?= base_url('') ?>/images/profile.jpg" alt=""
...
<div id="modal3" class="modal">
    ...
    <div class="modal-footer  red lighten-4">
        <a href="#" data-dismiss="modal"
            class="btn btn-sm waves-effect waves-light yellow modal-action modal-close">Batal</a> &nbsp;&nbsp;&nbsp;
        <a href="#" role="button" id="delete-button"
            class="btn btn-sm waves-effect waves-light red modal-action modal-close">Hapus</a>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </div>
</div>
...
<!-- data-tables -->
<script type="text/javascript" src="<?= base_url('') ?>/js/plugins/data-tables/js/jquery.dataTables.min.js"></script>
<script type="text/javascript" src="<?= base_url('') ?>/js/plugins/data-tables/data-tables-script.js"></script>
