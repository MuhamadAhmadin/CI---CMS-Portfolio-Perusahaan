      ...
      <div class="row">
        <div class="col-lg-4 col-md-6" data-aos="fade-up">
          <div class="icon-box">
            ...
            <p class="description">Kami menerima konsultasi IT baik untuk sekala kecil hingga enterprise</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
          <div class="icon-box">
            ...
            <p class="description">Kami menerima jasa business analyst untuk perusahaan anda</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
          <div class="icon-box">
            ...
            <p class="description">Kami menerima jasa UI/UX</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
          <div class="icon-box">
            ...
            <p class="description">Kami menawarkan jasa pembuatan website</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
          <div class="icon-box">
            ...
            <p class="description">Kami menawarkan jasa pembuatan aplikasi android</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
          <div class="icon-box">
            ...
            <p class="description">Kami menawarkan jasa pembuatan cms custom & wordpress</p>
          </div>
        </div>
      </div>
