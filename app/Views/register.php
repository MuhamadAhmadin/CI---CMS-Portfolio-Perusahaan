      ...
      <form action="<?= base_url('/register/save') ?>" method="post" class="login-form">
        <div class="row">
          <div class="input-field col s12 center">
            <img src="<?= base_url('') ?>/images/profile.jpg" alt="" class="circle responsive-img valign profile-image-login">
        ...
        <div class="row margin">
          <div class="input-field col s12">
            ...
            <input id="name" name="name" type="text" value="<?= set_value('name') ?>">
        ...
        <div class="row margin">
          <div class="input-field col s12">
            <i class="mdi-social-person-outline prefix"></i>
            <input id="email" name="email" type="email" value="<?= set_value('email') ?>">
        ...
        <div class="row">
          <div class="input-field col s6 m6 l6">
            <p class="margin medium-small"><a href="<?= base_url('login') ?>">Login Sekarang!</a></p>
          </div>     
        </div>
